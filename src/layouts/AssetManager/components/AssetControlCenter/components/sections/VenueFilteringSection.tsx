  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to remove this venue from the allowed venues list? This will prevent this venue from being used for settlement instructions involving this asset."
