...
export const SelfAssignDid = () => {
  ...
  const handleSelfAssign = async () => {
    ...
    try {
      // TODO remove ignore once SDK is updated to include selfRegisterDid in Identities module
      // @ts-expect-error - SDK types need to be updated to include selfRegisterDid
